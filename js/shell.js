(() => {
  ...
  function openSettings() {
    ...
    ov.innerHTML = `<div class="settings-modal" role="dialog" aria-modal="true" aria-labelledby="settingsTitle">
      ...
      <div class="setting-row"><div class="setting-copy"><strong>Approval Amount</strong><span>Show or hide the Approval amount in the record header.</span></div><select data-setting="showFinancial">${settingOptions([["show","Show"],["hide","Hide"]], settings.showFinancial)}</select></div>
